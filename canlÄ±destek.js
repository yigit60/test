...
exports.run = async (client, message, params) => {
  var channel = client.channels.find('id', '468777022840242186')
    const asdf = await client.channels.get(message.channel.id).createInvite()
  message.delete();
  const embed = new Discord.RichEmbed()
  .setTitle("» Supra | Canlı Destek")
  .setDescription("Canlı Desteği kullandğın için teşekkür ederiz, Seninle ekibim ilgilenicektir lütfen bekle!")
  .setFooter("30 Saniye içinde geri dönülmezse lütfen iletişime geçin Yigit | SupraBot Yapımcısı#7492")
